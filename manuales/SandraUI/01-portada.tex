%======================================================================
% PORTADA PROFESIONAL - SANDRA UI CONSOLA
%======================================================================
\thispagestyle{empty}
...
\begin{center}
    ...
    {\fontsize{38}{46}\selectfont \textbf{\textcolor{white}{\textsc{Sandra UI Consola}}}}\\[0.6em]
    {\LARGE \textcolor{sandraAccent}{\textbf{CONSOLA DE ADMINISTRACIÓN ENTERPRISE}}}
    ...
    {\large \textcolor{sandraLight}{\textbf{Versión 1.0}} \ \textbar\ \textcolor{sandraLight}{Stable Build}}
...
\begin{center}
    \begin{tikzpicture}
        \node[anchor=center, text width=0.8\textwidth, align=center, 
            ...
            {\normalsize \textcolor{sandraAccent}{\scss{\textbf{Autor}}}}\\[0.4em]
