%======================================================================
% PORTADA - SSSIFANB Manual de Usuario
...
\begin{center}
    ...
    \begin{tikzpicture}
        \node[circle, top color=white, bottom color=sandraLight, 
            ...
            \includegraphics[width=5cm]{../../assets/logos/sandra.png}
        };
        % Resplandores
    ...
    {\fontsize{38}{46}\selectfont \textbf{\textcolor{white}{\scshape{SSSIFANB}}}}\\[0.6em]
    {\LARGE \textcolor{sandraAccent}{\textbf{SISTEMA DE SEGURIDAD SOCIAL DE LA FANB}}}
    ...
    {\large \textcolor{sandraLight}{\textbf{Versión 1.0.0}} \ \textbar\ \textcolor{sandraLight}{IPSFANB Venezuela}}
...
\begin{center}
    \begin{tikzpicture}
        \node[anchor=center, text width=0.8\textwidth, align=center, 
            ...
            {\normalsize \textcolor{sandraAccent}{\scshape{\textbf{Autor}}}}\\[0.4em]
            {\Large \textbf{\textcolor{white}{Carlos Peña}}}\\[0.3em]
            {\small \textcolor{sandraLight}{\textit{Instituto de Previsión Social de la FANB}}}\\[0.5em]
