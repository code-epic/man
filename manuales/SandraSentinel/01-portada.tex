%======================================================================
% PORTADA - SANDRA SENTINEL
%======================================================================
\thispagestyle{empty}
\newgeometry{margin=0cm}

% Usar eso-pic para el fondo en lugar de tikz remember picture
\AddToShipoutPicture*{%
...
\begin{center}
    ...
    \begin{tikzpicture}
        \node[circle, top color=white, bottom color=sandraLight, 
            ...
            \includegraphics[width=5cm]{assets/sandra.png}
        };
        % Resplandores
    ...
    {\fontsize{38}{46}\selectfont \textbf{\textcolor{white}{\textsc{Sentinel}}}}\\[0.6em]
    {\LARGE \textcolor{sandraAccent}{\textbf{MOTOR DE CÁLCULO DE NÓMINA}}}
    ...
    {\Large \textbf{\textcolor{white}{\uppercase{Documento Científico e Ingeniería}}}}\\[1em]
    {\large \textcolor{sandraLight}{\textbf{Versión 1.0}} \ \textbar\ \textcolor{sandraLight}{Marzo 2026}}
...
\begin{center}
    \begin{tikzpicture}
        \node[anchor=center, text width=0.8\textwidth, align=center, 
            ...
            {\normalsize \textcolor{sandraAccent}{\textsc{\textbf{Autor del Proyecto}}}}\\[0.4em]
            {\Large \textbf{\textcolor{white}{Carlos Peña}}}\\[0.3em]
            {\small \textcolor{sandraLight}{\textit{Code Epic Technologies — Arquitectura Sovereign}}}\\[0.5em]
